...
function loadExperiment(d, textStatus, error) {
...
function initializeExperiment(experiment) {
  dataRef = storageRef.child('production-2/pilot/' + experiment.getSubjectId() + experiment.getCondition() + experiment.getSubcondition() + experiment.getVoice() + '.csv');
...
$( document ).ready(function() {
  checkWorker(jsPsych.data.urlVariables().workerId, 'production-2-workers').then(function(snapshot) {
