...
function makeTrial67(i, data, params, subject, is_by_word) {
  ...
  if(item.filler) {
    ...
    var prompt = "Did you understand the sentence? If so, please paraphrase its meaning.<br/>(Please type your answer into the box below.)"
  }
  else {
    var trial = params.trials[data[0]][data[1]];
    var prompt = "Did you understand the sentences? If so, please paraphrase its meaning.<br/>(Please type your answer into the box below.)"
  }
